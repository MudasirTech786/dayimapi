...
return new class extends Migration
{
    ...
    {
        Schema::create('shop_allotments', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('shop_id');
            $table->foreign('shop_id')->references('id')->on('project_shops')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('shop_allotments');
    }
};
